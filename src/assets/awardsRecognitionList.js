import awardSmallBiz from './awardSmallBiz.PNG';
import awardWebDesign from './awardWebDesign.PNG';
import awardPPC from './awardPPC.PNG';
import awardSocialMedia from './awardSocialMedia.PNG';

const awardsRecognitionList = [
  {
    id: 1,
    img: awardSmallBiz,
  ...
  },
  {
    id: 2,
    img: awardWebDesign,
    alt: 'Innovative Website Design badge',
  ...
  },
  {
    id: 3,
    img: awardPPC,
    alt: 'Top Performing PPC Campaign badge',
  ...
  {
    id: 4,
    img: awardSocialMedia,
    alt: 'Expertise in Social Media Marketing badge',
...
export default awardsRecognitionList;